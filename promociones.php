                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Promociones</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container-pdf ">
                        <object class="pdfView" type="application/pdf" data="pdf/FolletoNeumaticosCamion.pdf"></object>
                    </div>
                </div>
            </div>
        </div>
